...
final class CalendarTests: XCTestCase {
    ...
    func testNextWeekday() {
        ...
        let n0 = Calendar.standard.next(.monday, after: date)
        ...
        let n1 = Calendar.standard.next(.friday, after: date)
